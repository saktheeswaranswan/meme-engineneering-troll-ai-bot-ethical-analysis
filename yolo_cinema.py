...
Original file is located at
    https://colab.research.google.com/drive/1RIrMcNd7v_R-LSFrpt565XqPJT-EKjuy
"""

!pip install ultralytics

# -*- coding: utf-8 -*-
"""yolosasvemovieanno.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1kSc_9Jvijez1ze-Vt1FL-Lxk-HEkhzbx
"""
...
cap = cv2.VideoCapture("/content/drive/MyDrive/myss/appp.mp4")
if not cap.isOpened():
...
out = cv2.VideoWriter("output/dttttice.mp4", fourcc, fps, (width, height))
...
# YouTube URL
url = "https://www.youtube.com/watch?v=iNp8zFd5r8Y"

# Download the best quality mp4 format
os.system(f'yt-dlp -f "bestvideo[ext=mp4]+bestaudio[ext=m4a]/mp4" -o "input_video.mp4" {url}')
...
!mv /content/output/huttithare.json  /content/drive/MyDrive/myss
...
!mv /content/output/apacalyptoaianalyisis.json   /content/drive/MyDrive/myss